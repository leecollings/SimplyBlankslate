...
load_theme_textdomain( 'simplyblankslate', get_template_directory() . '/languages' );
...
register_nav_menus( array( 'main-menu' => esc_html__( 'Main Menu', 'simplyblankslate' ) ) );
}
...
add_action( 'wp_footer', 'simplyblankslate_footer_scripts' );
function simplyblankslate_footer_scripts() {
?>
<script>
...
add_filter( 'document_title_separator', 'simplyblankslate_document_title_separator' );
function simplyblankslate_document_title_separator( $sep ) {
$sep = '|';
return $sep;
}
add_filter( 'the_title', 'simplyblankslate_title' );
function simplyblankslate_title( $title ) {
if ( $title == '' ) {
return '...';
} else {
return $title;
...
add_filter( 'intermediate_image_sizes_advanced', 'simplyblankslate_image_insert_override' );
function simplyblankslate_image_insert_override( $sizes ) {
...
add_action( 'wp_head', 'simplyblankslate_pingback_header' );
function simplyblankslate_pingback_header() {
...
function simplyblankslate_custom_pings( $comment ) {
?>
